...
class spectrum:
    ...
    def unpickleFile(self):
        ...
        while(res == False):
            try:
                with open('/home/xilinx/jupyter_notebooks/strathRFM/config.pkl', 'rb') as fo:
    ...
    def continuous_scan(self):
        ...
        cont_scan = True
        path_filename = '/home/xilinx/jupyter_notebooks/strathRFM/spectrum_data/S_'
        ...
        while (cont_scan):
            ...
            for curr in _mins:
                ...
                while(curr != int(now.strftime("%M"))):
                    ...
                    # disable in boot mode
                    print("  waiting for T-"+str(T)+" "+ animation[anim_idx % len(animation)]+white_space,end="\r",flush = True)
                    anim_idx += 1
